...
/**
 * This class provides a wrapper for network errors when making requests to MultiWoven API
 */
export class MultiwovenError extends Error {
  /**
   * The response body
   */
